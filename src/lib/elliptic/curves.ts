...
import { short, mont, edwards } from './curve'
export const curves = {
	PresetCurve,
}
...
function PresetCurve(options) {
	if (options.type === 'short') this.curve = new short(options)
	else if (options.type === 'edwards') this.curve = new edwards(options)
	else this.curve = new mont(options)
	this.g = this.curve.g
	this.n = this.curve.n
